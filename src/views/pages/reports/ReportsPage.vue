<template>
  <Panel
    ...
    toggleable
  >
    <TabView v-model:active-index="generalTabIndex">
      <TabPanel header="Report By Date">
        <template v-if="generalTabIndex == 0">
              ...
              <div class="col-12 md:col-6">
                ...
                >
                  ...
                  <p class="text-center p-5 text-500">
                    Generated Chart <span>from</span> {{ dateFormat(dates.from_date, DATE_FORMAT_DATE) }}
                    <span>to</span>
                    {{ dateFormat(dates.to_date, DATE_FORMAT_DATE) }}
                  </p>
                </div>
                ...
                <div class="card mb-0 p-4">
                  <div class="flex justify-content-between">
                    ...
                    <div v-else>
                      ...
                      <div class="text-900 font-medium text-xl">
                        {{ formatCurrency(Number(sub_trans.amount ?? 0)) }}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="flex justify-content-between">
                    ...
                    <div v-else>
                      <Label
                        ...
                        >Total loan amortization collected</Label
                      >
                      <div class="text-900 font-medium text-xl">
      ...
      <TabPanel header="All Time">
        <template v-if="generalTabIndex == 1">
          ...
          <div class="grid col-12 flex-column gap-5 mt-3">
            ...
            >
              ...
              <small class="text-500"
                >Member report contains current active information, e.g share capital balance, mortuary
                contribution.</small
              >
            </Panel>
            <Panel
