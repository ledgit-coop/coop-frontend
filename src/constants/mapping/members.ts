...
export function mapMemberFormToPostMemberPayload(memberForm: MemberForm): PostMemberPayload {
  const postMemberPayload: PostMemberPayload = {
    ...
    in_case_emergency_person: memberForm.in_case_emergency_person,
...
export function mapMemberToMemberForm(member: Member): MemberForm {
  ...
  const memberForm: MemberForm = {
    ...
    in_case_emergency_address: member.in_case_emergency_address,
    in_case_emergency_contact: member.in_case_emergency_contact,
    in_case_emergency_person: member.in_case_emergency_person,
