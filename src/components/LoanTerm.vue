<template>
  ...
  >
    <div class="grid p-fluid formgrid">
      ...
      <div
        v-if="
          [RepaymentCycle.BIWEEKLY.toString(), RepaymentCycle.MONTHLY.toString()].includes(
            data.form.repayment_cycle ?? ''
          )
        "
        class="field col-12 lg:col-4"
      >
        <Label
          help-text="When is the next payroll or income date?"
          for="number-repayments"
          >Income Date <span class="font-italic">(Optional)</span></Label
        >
